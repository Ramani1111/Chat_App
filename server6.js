...
const io = new Server(server, {
  cors: { origin: 'http://172.16.4.11:4200', methods: ['GET', 'POST'] }
});

app.use(cors({ origin: 'http://172.16.4.11:4200', methods: ['GET', 'POST', 'DELETE', 'PUT'], allowedHeaders: ['Authorization', 'Content-Type'] }));
...
app.get('/admin/messages/:userId', verifyToken, verifyAdmin, async (req, res) => {
  try {
    ...
    // Add formattedTimestamp to messages if not present
